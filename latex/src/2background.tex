...
an detailed overview see \citeauthor{buzzy_computed_2008}~\cite[Chapter 2]{buzug_computed_2008}. \todo{Maybe
	read through chapter 2 and add some parts}
...
As already eluded to in the section about the Radon Transform \ref{sec:radon_transform}. There do
...
\begin{figure}
	\centering
	\input{figures/testing_something.pgf}
