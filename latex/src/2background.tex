...
\inlinetodo{Phase forward model as a goal of this chapter}
...
measurements is similar to the one in conventional X-ray attenuation CT\@.
...
As a small excursion. X-rays do also exhibit scattering, though the scattering angles are small. The
above described setup also measures the scattering component of the scanned object. Compared to
phase-shifts, which lead to a lateral displacement of the interferometer pattern, scattering reduces
the amplitude of the oscillation. This is different from attenuation, which causes a drop of the
average intensity. Imaging modalities based on the scattering component are referred to as
