...
\begin{figure}
	...
	\makebox[\textwidth]{ \makebox[1.2\textwidth]{%
			\rotatebox[x=-5em, y=0em]{90}{\bfseries \(45^\circ\) projection\strut}
			...
			\end{subfigure}%
			\begin{subfigure}{0.3\textwidth}
				\stackinset{c}{}{t}{-.2in}{\bfseries Based on Cubic B-Splines\strut}{%
	...
	\makebox[\textwidth]{ \makebox[1.2\textwidth]{%
			\rotatebox[x=-4.75em, y=0em]{90}{\bfseries \(180^\circ\) projection\strut}
			\begin{subfigure}{0.3\textwidth}
...
\begin{figure}[h]
	\centering
	\makebox[\textwidth]{ \makebox[1.3\textwidth]{%
			\rotatebox[x=-3em, y=0em]{90}{\bfseries Reconstruction \strut}
			\begin{subfigure}{0.3125\textwidth}
				\stackinset{c}{}{t}{-.2in}{}{%
	...
	\caption{\subref{fig:rectangle_recon_artifacts_blob}--\subref{fig:rectangle_recon_artifacts_joseph}
                ...
                The blob basis function use \(m=2\), \(\alpha=10.83\) and \(a=2\) and cubic
                B-Splines are used as basis function for the projectors
...
\begin{figure}[h]
	...
	\caption{\subref{fig:reconstruction_noise_blob}--\subref{fig:reconstruction_noise_joseph}
		...
		B-Spline basis, Siddon's method and finally Joseph's method. The parameters for the
		blob basis function are \(m=2\), \(\alpha=10.83\) and \(a=2\) and cubic B-Splines
		are used as basis function. The second row
