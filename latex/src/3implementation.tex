...
basis functions \insertref{B-Spline chapter}, the projection of \(n\)-dimensional B-Splines yield a
...
\inlinetodo{Mention the typical artefacts of Siddon's and Joseph's}
...
\begin{figure}[h]
	...
	\caption{Visualization of Siddon's method. Siddon's method exactly computes the intersection
		...
		enters and exists each voxel (marked as black
                dots).\inlinetodo{reference this}}\label{fig:visualization_siddon_traversal}
\end{figure}
